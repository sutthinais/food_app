...
class _BottomNavBarState extends State<BottomNavBar> {
  ...
  List<Map<String, dynamic>> _navitems = [
    {"icon": "assets/icons/home.svg", "title": "หลัก"},
    {"icon": "assets/icons/search.svg", "title": "ค้าหา"},
    {"icon": "assets/icons/order.svg", "title": "ออเดอร์"},
    {"icon": "assets/icons/profile.svg", "title": "โปรไฟล์"},
  ];
